...
public class SDWANController extends SDNController {
	...
	public void initSdWANTopology(List<ConfiguationEntity.SwitchEntity> switchEntites, List<ConfiguationEntity.LinkEntity> linkEntites, List<Switch> datacenterGateway) {
