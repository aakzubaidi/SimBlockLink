...
import IoTSimOsmosis.cloudsim.sdn.NetworkOperatingSystem;
...
public class SDNController extends NetworkOperatingSystem {
	...
	public void initSdWANTopology(List<ConfiguationEntity.SwitchEntity> switches, List<ConfiguationEntity.LinkEntity> wanLinks, List<Switch> datacenterGateways) {
