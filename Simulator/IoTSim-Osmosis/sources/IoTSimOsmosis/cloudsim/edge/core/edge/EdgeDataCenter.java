...
import IoTSimOsmosis.cloudsim.edge.core.edge.ConfiguationEntity.HostEntity;
import IoTSimOsmosis.cloudsim.edge.core.edge.ConfiguationEntity.LinkEntity;
import IoTSimOsmosis.cloudsim.edge.core.edge.ConfiguationEntity.SwitchEntity;
...
import IoTSimOsmosis.osmosis.core.OsmosisTags;
import IoTSimOsmosis.osmosis.core.Topology;
...
//					"; and BW is " + getFlow.getFlowBandwidth());
	...
	public void initEdgeTopology(List<EdgeDevice> devices, List<SwitchEntity> switchEntites, List<LinkEntity> linkEntites){
		...
		for(LinkEntity linkEntity : linkEntites){									
			...
			//	System.out.println("Building links from " + src + " to " + dst );
